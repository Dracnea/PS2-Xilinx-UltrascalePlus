...
xvhdl -2008 "$ROOT/rtl/gs/gs_addr_pkg.vhd" "$ROOT/rtl/gs/gs_edge_dda.vhd" "$ROOT/rtl/gs/gs_chan_dda.vhd" "$ROOT/rtl/gs/gs_texaddr.vhd" "$ROOT/rtl/gs/gs_clut.vhd" "$ROOT/rtl/gs/gs_texsample.vhd" "$ROOT/rtl/gs/gs_texcache.vhd" "$ROOT/rtl/gs/gs_gif.vhd" > xvhdl.log 2>&1 || { tail -20 xvhdl.log; exit 1; }
