...
xvhdl -2008 "$ROOT/rtl/gs/gs_addr_pkg.vhd" "$ROOT/rtl/gs/gs_edge_dda.vhd" "$ROOT/rtl/gs/gs_chan_dda.vhd" "$ROOT/rtl/gs/gs_gif.vhd" "$ROOT/rtl/gs/gs_lmem.vhd" "$ROOT/rtl/gs/gs_pcrtc.vhd" "$ROOT/rtl/gs/gs_top.vhd" > xvhdl.log 2>&1 || { tail -20 xvhdl.log; exit 1; }
